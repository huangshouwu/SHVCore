...
@implementation NSArray(SVHSafeObject)
...
@implementation NSMutableArray(SVHSafeObject)
...
@implementation NSDictionary(SVHSafeObject)
...
@implementation NSMutableDictionary(SVHSafeObject)
