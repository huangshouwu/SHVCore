...
- (GJTDeleteButton*)deleteButton{
    if (!_deleteButton) {
        ...
        [_deleteButton setImage:GJTResourceImageWithName(@"GJTKeyboardDeleteButton") forState:UIControlStateNormal];
...
- (GJTBaseButton*)registerFirstResponderButton{
    if (!_registerFirstResponderButton) {
        ...
        [_registerFirstResponderButton setImage:GJTResourceImageWithName(@"GJTKeyboardHideButton") forState:UIControlStateNormal];
