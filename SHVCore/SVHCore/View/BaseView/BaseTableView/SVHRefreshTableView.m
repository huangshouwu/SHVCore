...
@interface SVHRefreshTableView ()<UITableViewDelegate, SRRefreshDelegate>

@property (weak, nonatomic) id<UITableViewDelegate> tbDelegate;

@end

@implementation SVHRefreshTableView
...
- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate {
    if (![self isKindOfClass:[SVHRefreshTableView class]]) {
        return;
    }
    if (self.showRefreshView) {
