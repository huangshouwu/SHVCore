...
@interface SVHUnderlineSegment : GJTBaseView
...
@property (nonatomic, assign)BOOL itemWidthAdjustContent;//item宽度是否根据title内容计算，否将根据view宽度与titles个数计算平均宽度，默认否；
...
@interface SVHUnderlineSegmentCell : UICollectionViewCell
