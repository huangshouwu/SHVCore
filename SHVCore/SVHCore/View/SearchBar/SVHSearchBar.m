...
#import "SVHSearchBar.h"
#import "SVHUIViewAdditions.h"
#import "SVHCommonTool.h"

@interface SVHSearchBar ()<UITextFieldDelegate>
@end

@implementation SVHSearchBar
...
- (UITextField*)textField{
    if (!_textField) {
        ...
        _textField.background = SVHResourceImageWithName(@"SearchBarBackgroundImage");
        ...
        _textField.leftView = [self createTextFieldLeftViewWithImage:SVHResourceImageWithName(@"SearchBarScopeImage") height:30];
    }
    return _textField;
}
