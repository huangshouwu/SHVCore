...
@interface SVHBaseViewController ()<UIGestureRecognizerDelegate>{
...
@implementation SVHBaseViewController
...
- (void)resetViewFrame:(BOOL)isRoot{
    if (isRoot) {
        self.view.height = CGRectGetHeight([[UIScreen mainScreen] bounds]) - SVHStatusBarHeight - CGRectGetHeight(self.navigationController.navigationBar.frame) - SVHTabBarHeight;
    }else {
        self.view.height = CGRectGetHeight([[UIScreen mainScreen] bounds]) - SVHStatusBarHeight - CGRectGetHeight(self.navigationController.navigationBar.frame);
    }
}
