...
#import "SVHBaseTableViewController.h"

@interface SVHBaseTableViewController (){
    UITableViewStyle _tableViewStyle;
}

@end

@implementation SVHBaseTableViewController
...
- (void)resetViewFrame:(BOOL)isRoot{
    [super resetViewFrame:isRoot];
    self.tableView.frame = self.view.bounds;
}

- (SVHBaseTableView*)tableView{
    if (!_tableView) {
        _tableView = [[SVHBaseTableView alloc] initWithFrame:self.view.bounds style:_tableViewStyle showDragView:YES];
