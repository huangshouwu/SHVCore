...
@class GJTRefreshTableView;
typedef void (^RefreshTableViewDidStartRefreshBlock)(GJTRefreshTableView *resreshTableView);

@interface GJTRefreshTableView : UITableView
